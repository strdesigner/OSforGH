...
namespace SurfAutoCreation
{
    public class SurfAutoCreation : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public SurfAutoCreation()
          : base("SurfAutoCreation", "SurfAutoCreation",
              "select area and create surfaces which are divided by beams",
              "OpenSees", "PreProcess")
        {
        }
        ...
        {
            pManager.AddPointParameter("P", "P", "floor surface edge points(DataList)", GH_ParamAccess.list);
        ...
        {
            var pts = new List<Point3d>(); DA.GetDataList("P", pts); pts.Add(pts[0]);
            ...
            var lines_inside_surface = new List<Curve>(); var ijkl = new List<List<int>>(); var ij = new List<List<int>>();
            ...
            for (int e = 0; e < breps.Length; e++)
            {
                if (sz.Count == 1)
                {
                    s_load.AppendRange(new List<GH_Number> {new GH_Number(ijkl[e][0]), new GH_Number(ijkl[e][1]), new GH_Number(ijkl[e][2]), new GH_Number(ijkl[e][3]), new GH_Number(sz[0]) }, new GH_Path(e));
                }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return OpenSeesUtility.Properties.Resources.surfautocreation;
            }
        }
        ...
        {
            get { return new Guid("3db7bec7-f851-4591-af72-387778139412"); }
        }
    }
}
...
{
    public class ElasticAnalysisforN : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public ElasticAnalysisforN()
          : base("Analysis using OpenSees", "Elastic Analysis for N",
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("sectional_force for timber joints", "sec_f(for N)", "[[element No.,Pxi,Pyi,Pzi,Mxi,Myi,Mzi,Pxj,Pyj,Pzj,Mxj,Myj,Mzj,Pxc,Pyc,Pzc,Mxc,Myc,Mzc],...](DataTree)", GH_ParamAccess.tree);///15
        }
                        ...
                        if (alpha > 0.0)
                        {
                            ...
                            if (v3[2] > Math.Sqrt(Math.Pow(v3[0], 2) + Math.Pow(v3[1], 2)))//壁の時
                            {
                                if (Math.Abs(ri[2] - rj[2]) < Math.Abs(rj[2] - rk[2]))//ij辺が幅方向の時
                                {
                                    ...
                                    var N = (Math.Abs(N1 * Math.Sqrt(1 - Math.Pow(Cos1[e2], 2))) + Math.Abs(N2 * Math.Sqrt(1 - Math.Pow(Cos2[e2], 2)))) / 2.0;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return OpenSeesUtility.Properties.Resources.ElasticAnalysisforN;
            }
        }
        ...
        {
            get { return new Guid("cf013f76-6989-4a2e-97ad-ed8fc79a592a"); }
        }
    }
}